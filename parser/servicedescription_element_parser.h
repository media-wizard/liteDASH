...
#ifndef DASH_SERVICEDESCRIPTION_ELEMENT_PARSER_H_
#define DASH_SERVICEDESCRIPTION_ELEMENT_PARSER_H_
...
class ServiceDescriptionElementParser: public ElementBaseParser {
...
#endif /* DASH_SERVICEDESCRIPTION_ELEMENT_PARSER_H_ */
