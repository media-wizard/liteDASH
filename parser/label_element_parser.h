...
#ifndef DASH_LABEL_ELEMENT_PARSER_H_
#define DASH_LABEL_ELEMENT_PARSER_H_
...
class LabelElementParser: public ElementBaseParser {
...
#endif /* DASH_LABEL_ELEMENT_PARSER_H_ */
