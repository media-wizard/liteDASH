...
#ifndef DASH_TIMELINE_ELEMENT_PARSER_H_
#define DASH_TIMELINE_ELEMENT_PARSER_H_
...
class TimelineElementParser: public ElementBaseParser {
...
#endif /* DASH_TIMELINE_ELEMENT_PARSER_H_ */
