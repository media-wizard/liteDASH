...
#ifndef DASH_METRICS_ELEMENT_PARSER_H_
#define DASH_METRICS_ELEMENT_PARSER_H_
...
class MetricsElementParser: public ElementBaseParser {
...
#endif /* DASH_METRICS_ELEMENT_PARSER_H_ */
