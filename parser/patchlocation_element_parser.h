...
#ifndef DASH_PATCHLOCATION_ELEMENT_PARSER_H_
#define DASH_PATCHLOCATION_ELEMENT_PARSER_H_
...
class PatchLocationElementParser: public ElementBaseParser {
...
#endif /* DASH_PATCHLOCATION_ELEMENT_PARSER_H_ */
