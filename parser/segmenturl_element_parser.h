...
#ifndef DASH_SEGMENTURL_ELEMENT_PARSER_H_
#define DASH_SEGMENTURL_ELEMENT_PARSER_H_
...
class SegmentURLElementParser: public ElementBaseParser {
...
#endif /* DASH_SEGMENTURL_ELEMENT_PARSER_H_ */
