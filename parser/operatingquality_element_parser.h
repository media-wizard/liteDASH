...
#ifndef DASH_OPERATINGQUALITY_ELEMENT_PARSER_H_
#define DASH_OPERATINGQUALITY_ELEMENT_PARSER_H_
...
class OperatingQualityElementParser: public ElementBaseParser {
...
#endif /* DASH_OPERATINGQUALITY_ELEMENT_PARSER_H_ */
