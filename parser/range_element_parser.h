...
#ifndef DASH_RANGE_ELEMENT_PARSER_H_
#define DASH_RANGE_ELEMENT_PARSER_H_
...
class RangeElementParser: public ElementBaseParser {
...
#endif /* DASH_RANGE_ELEMENT_PARSER_H_ */
