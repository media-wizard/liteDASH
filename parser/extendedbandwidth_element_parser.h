...
#ifndef DASH_EXTENDEDBANDWIDTH_ELEMENT_PARSER_H_
#define DASH_EXTENDEDBANDWIDTH_ELEMENT_PARSER_H_
...
class ExtendedBandwidthElementParser: public ElementBaseParser {
...
#endif /* DASH_EXTENDEDBANDWIDTH_ELEMENT_PARSER_H_ */
