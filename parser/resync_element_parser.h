...
#ifndef DASH_RESYNC_ELEMENT_PARSER_H_
#define DASH_RESYNC_ELEMENT_PARSER_H_
...
class ResyncElementParser: public ElementBaseParser {
...
#endif /* DASH_RESYNC_ELEMENT_PARSER_H_ */
