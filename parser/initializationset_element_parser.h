...
#ifndef DASH_INITIALIZATIONSET_ELEMENT_PARSER_H_
#define DASH_INITIALIZATIONSET_ELEMENT_PARSER_H_
...
class InitializationSetElementParser: public RepresentationBaseElementParser {
...
#endif /* DASH_INITIALIZATIONSET_ELEMENT_PARSER_H_ */
