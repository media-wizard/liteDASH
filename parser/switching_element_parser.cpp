...
bool SwitchingElementParser::ParseStart(const std::string &element_name,
    ElementBase *elem_out, const char **attrib) {
  Switching *elem = static_cast<Switching*>(elem_out);
...
ElementBase* SwitchingElementParser::CreateElement(
