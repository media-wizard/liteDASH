...
#ifndef DASH_SWITCHING_ELEMENT_PARSER_H_
#define DASH_SWITCHING_ELEMENT_PARSER_H_
...
class SwitchingElementParser: public ElementBaseParser {
...
#endif /* DASH_SWITCHING_ELEMENT_PARSER_H_ */
