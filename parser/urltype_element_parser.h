...
#ifndef DASH_URLTYPE_ELEMENT_PARSER_H_
#define DASH_URLTYPE_ELEMENT_PARSER_H_
...
class URLTypeElementParser: public ElementBaseParser {
...
#endif /* DASH_URLTYPE_ELEMENT_PARSER_H_ */
