...
#ifndef DASH_DESCRIPTOR_ELEMENT_PARSER_H_
#define DASH_DESCRIPTOR_ELEMENT_PARSER_H_
...
class DescriptorElementParser: public ElementBaseParser {
...
#endif /* DASH_DESCRIPTOR_ELEMENT_PARSER_H_ */
