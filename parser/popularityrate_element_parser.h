...
#ifndef DASH_POPULARITYRATE_ELEMENT_PARSER_H_
#define DASH_POPULARITYRATE_ELEMENT_PARSER_H_
...
class PopularityRateElementParser: public ElementBaseParser {
...
#endif /* DASH_POPULARITYRATE_ELEMENT_PARSER_H_ */
