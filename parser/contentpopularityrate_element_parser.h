...
#ifndef DASH_CONTENTPOPULARITYRATE_ELEMENT_PARSER_H_
#define DASH_CONTENTPOPULARITYRATE_ELEMENT_PARSER_H_
...
class ContentPopularityRateElementParser: public ElementBaseParser {
...
#endif /* DASH_CONTENTPOPULARITYRATE_ELEMENT_PARSER_H_ */
