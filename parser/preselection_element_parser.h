...
#ifndef DASH_PRESELECTION_ELEMENT_PARSER_H_
#define DASH_PRESELECTION_ELEMENT_PARSER_H_
...
class PreselectionElementParser: public RepresentationBaseElementParser {
...
#endif /* DASH_PRESELECTION_ELEMENT_PARSER_H_ */
