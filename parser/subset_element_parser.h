...
#ifndef DASH_SUBSET_ELEMENT_PARSER_H_
#define DASH_SUBSET_ELEMENT_PARSER_H_
...
class SubsetElementParser: public ElementBaseParser {
...
#endif /* DASH_SUBSET_ELEMENT_PARSER_H_ */
