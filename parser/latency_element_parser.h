...
#ifndef DASH_LATENCY_ELEMENT_PARSER_H_
#define DASH_LATENCY_ELEMENT_PARSER_H_
...
class LatencyElementParser: public ElementBaseParser {
...
#endif /* DASH_LATENCY_ELEMENT_PARSER_H_ */
