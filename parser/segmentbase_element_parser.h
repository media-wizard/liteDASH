...
#ifndef DASH_SEGMENTBASE_ELEMENT_PARSER_H_
#define DASH_SEGMENTBASE_ELEMENT_PARSER_H_
...
class SegmentBaseElementParser: public ElementBaseParser {
...
#endif /* DASH_SEGMENTBASE_ELEMENT_PARSER_H_ */
