...
#ifndef DASH_PERIOD_ELEMENT_PARSER_H_
#define DASH_PERIOD_ELEMENT_PARSER_H_
...
class PeriodElementParser: public ElementBaseParser {
...
#endif /* DASH_PERIOD_ELEMENT_PARSER_H_ */
