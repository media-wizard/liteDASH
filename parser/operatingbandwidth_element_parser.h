...
#ifndef DASH_OPERATINGBANDWIDTH_ELEMENT_PARSER_H_
#define DASH_OPERATINGBANDWIDTH_ELEMENT_PARSER_H_
...
class OperatingBandwidthElementParser: public ElementBaseParser {
...
#endif /* DASH_OPERATINGBANDWIDTH_ELEMENT_PARSER_H_ */
