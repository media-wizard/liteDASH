...
#ifndef DASH_EVENT_ELEMENT_PARSER_H_
#define DASH_EVENT_ELEMENT_PARSER_H_
...
class EventElementParser: public ElementBaseParser {
...
#endif /* DASH_EVENT_ELEMENT_PARSER_H_ */
