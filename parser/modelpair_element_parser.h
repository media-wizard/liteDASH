...
#ifndef DASH_MODELPAIR_ELEMENT_PARSER_H_
#define DASH_MODELPAIR_ELEMENT_PARSER_H_
...
class ModelPairElementParser: public ElementBaseParser {
...
#endif /* DASH_MODELPAIR_ELEMENT_PARSER_H_ */
