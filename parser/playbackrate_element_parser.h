...
#ifndef DASH_PLAYBACKRATE_ELEMENT_PARSER_H_
#define DASH_PLAYBACKRATE_ELEMENT_PARSER_H_
...
class PlaybackRateElementParser: public ElementBaseParser {
...
#endif /* DASH_PLAYBACKRATE_ELEMENT_PARSER_H_ */
