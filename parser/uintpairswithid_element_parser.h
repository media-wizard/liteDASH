...
#ifndef DASH_UINTPAIRSWITHID_ELEMENT_PARSER_H_
#define DASH_UINTPAIRSWITHID_ELEMENT_PARSER_H_
...
class UIntPairsWithIDElementParser: public ElementBaseParser {
...
#endif /* DASH_UINTPAIRSWITHID_ELEMENT_PARSER_H_ */
