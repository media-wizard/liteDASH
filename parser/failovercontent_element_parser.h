...
#ifndef DASH_FAILOVERCONTENT_ELEMENT_PARSER_H_
#define DASH_FAILOVERCONTENT_ELEMENT_PARSER_H_
...
class FailoverContentElementParser: public ElementBaseParser {
...
#endif /* DASH_FAILOVERCONTENT_ELEMENT_PARSER_H_ */
