...
#ifndef DASH_PRODUCERREFERENCETIME_ELEMENT_PARSER_H_
#define DASH_PRODUCERREFERENCETIME_ELEMENT_PARSER_H_
...
class ProducerReferenceTimeElementParser: public ElementBaseParser {
...
#endif /* DASH_PRODUCERREFERENCETIME_ELEMENT_PARSER_H_ */
