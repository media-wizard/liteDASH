...
#ifndef DASH_SEGMENTLIST_ELEMENT_PARSER_H_
#define DASH_SEGMENTLIST_ELEMENT_PARSER_H_
...
class SegmentListElementParser: public MultipleSegmentBaseElementParser {
...
#endif /* DASH_SEGMENTLIST_ELEMENT_PARSER_H_ */
